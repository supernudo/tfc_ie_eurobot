...
Respecto a las baliza catadióptrica, su construcción es simple. La figura \ref{fig_baliza_catadioptrica} muestra la baliza construida. Esta se ha realizado a partir de un cilindro de metacrilato de $8cm$ de diámetro exterior al que se le han añadido unas tapas en sus extremos y se ha forrado de catadióptrico adhesivo.

Como se puede observar, aunque se han realizado dos implementaciones mecánicas diferentes ambas tienen los mismos elementos. Esto ha permitido reutilizar la misma arquitectura hardware y el mismo software para ambas balizas. Únicamente se diferencian en su respuesta en la medición de distancias, por ello ha sido necesario realizar un modelado y calibración individual para cada una de ellas.
