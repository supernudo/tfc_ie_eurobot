...
\section{Ajustes, modelado experimental y resultados}

La baliza faro necesita de ciertos ajustes con el fin de obtener el rango de detección máximo para cada tipo de implementación realizada. El procedimiento para realizar

\subsection{Ajuste del rango de medida}
