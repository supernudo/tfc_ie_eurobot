...
La obtención de la distancia mediante un \emph{array} de datos permite obtener la medida sin penalizar en tiempo de cálculo.
...
\caption[]{Discretización del modelo continuo de medida de distancia para su mapeado en un \emph{array} de datos }
