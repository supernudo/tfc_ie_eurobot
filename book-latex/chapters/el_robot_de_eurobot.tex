...
Al la hora de plantear el desarrollo de un robot de Eurobot es recomendable es empezar desde el diseño de la estrategia, siguiendo con la mecánica y por último el diseño electrónico y software. De esta forma, la estrategia es la que impondrá las restricciones de la mecánica y ésta a su vez fijará las necesidades de la electrónica, y toda ellas, las necesidades del software.
...
Diseñar una estrategia es un proceso en el que puede participar cualquier persona y la parte más divertida ya que se cuenta con recursos ilimitados: la imaginación. Aun así es de mucha utilidad contar con los elementos del juego  y un campo de juego físico. Antes de nada es necesario y recomendable leer y estudiar bien las reglas del juego. Algunos equipo suelen organizar fines de semana en los que dedican el tiempo a estudiar las reglas y diseñar la estrategia\footnote{Este tipo de actividades además ayudan a unir al equipo de Eurobot y a que sus integrantes se conozcan mejor}. La figura \ref{finde_robotico} muestra el campo y elementos de juegos construidos rudimentariamente durante un fin de semana \emph{robótico} y que se utilizaron para simular las primeras estrategias de juego.

\begin{figure}[h]
\centering
\includegraphics[width=.8\textwidth]{finde_robotico}
\caption[Elementos y campo de juego utilizado para discutir las primeras estrategias de juego]{Elementos y campo de juego utilizado para discutir las primeras estrategias de juego}
...
En función del objetivo del equipo Para ganan un partido de Eurobot 

La puntuación objetivo a obtener en cada partido determina las tareas a realizar
...
Además hay que tener en cuenta cuanto de accesible es un elemento de juego. Por ejemplo si está muy cerca de las esquinas del campo, dependiendo de la forma de cada robot puede que el elemento no sea accesible o que sean necesarias muchas maniobras para llegar a él.
...
El tiempo en un partido de Eurobot es escaso, es por ello que un robot 
...
\subsection{Diseño y fabricación de la mecánica}
\label{sec:diseño_y_fabricacion_mecanica}

\subsection{Diseño y fabricación de la electrónica}
\label{sec:diseno_y_fabricación_electronica}

\subsection{Implementación software de la funcionalidad del robot}
...
\subsection{Depuración y mejoras}
\label{sec:depuracion_y_mejoras}
