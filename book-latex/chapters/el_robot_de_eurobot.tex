...
\item Puesta en marcha, depuración y mejoras
\end{enumerate}
...
La puesta en marcha y verificación constituye la fase más importante si cabe de todas. Cada parte nueva o mejora del robot ha de ser probada en condiciones reales y verificada, de forma que se asegure una perceptibilidad de su funcionamiento. Esto es así tanto para el funcionamiento mecánico y electrónico, como para el funcionamiento software. Así pues esta es una fase implícita en cualquiera de las otras fases o partes a desarrollar de un robot de Eurobot.

A medida que se vaya probando.... prueba por partes..... errores a la luz en partidos .....
