...
Cada robot que participa en Eurobot es único y diferente al resto, sin embargo todos tienen en común ciertas características o funcionalidades que vienen determinadas o derivadas de las reglas del juego. Como se ha comentado en el capitulo \ref{introduccion} cada año la prueba en la que competir o a resolver es diferente, esto tiene una implicación directa en el diseño mecánico especialmente en los mecanismos diseñados para manipular los elementos de juego propios de la prueba. Sin embargo, si comparamos las reglas del juego de varios años se observan especificaciones funcionales comunes que repercuten en el diseño de la mecánica, de la electrónica o del software, de forma que dicho diseño puede ser reutilizado de un año para otro.

\section{Especificaciones funcionales}

Un robot de Eurobot ha de ser completamente autónomo, además sin tener en cuenta la temática de una prueba, ha de tener principalmente las siguientes funcionalidades:

\begin{enumerate}
\item Iniciar el partido mediante una cuerda y pararse automáticamente al final del tiempo de partido (90 segundos)
\item Desplazarse hasta la posición de los elementos de juego
\item Evitar chocar con elementos del campo de juego y con otros robots oponentes
\item Sincronizar sus movimientos con un robot secundario (en caso de permitirse dos robots por equipo).
\end{enumerate}

Y mecánicamente ha de cumplir las siguientes restricciones:
...
Además el campo de juego cuenta con 3 soportes para balizas adicionales a disposición de cada equipo (ver figura \ref{balizas_campo}). Estos soportes adicionales están pensados para facilitar la localización de los robots en el campo de juego. Por ejemplo, un sistema compuesto por una baliza reflectante, un emisor y un sensor de luz puede ser utilizado para localizar la esquina del campo donde se encuentra una canasta.

Las restricciones acorde con las balizas son las siguientes:

\begin{itemize}
\item Balizas del oponente: dimensiones máximas de 80x80x80 cm y peso máximo de 0,5 Kg.
...
Además las reglas especifican otras generalidades respecto a temas como:
