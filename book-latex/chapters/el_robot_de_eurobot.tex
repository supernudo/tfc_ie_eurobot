...
Cada una de estas partes principales de un robot de Eurobot tienen pueden implicar un desarrollo mecánico, electrónico y de software, dependiendo el caso:
...
El desplazamiento y localización del robot de Eurobot implica un desarrollo conjunto de mecánica, electrónica y software. 

El desplazamiento lleva implícito una localización, ambas funciones permiten realizar trayectorias desde un punto de inicio hasta un punto de destino y con una velocidad y aceleración determinadas.   
