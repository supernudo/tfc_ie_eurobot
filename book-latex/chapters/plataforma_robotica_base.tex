...
De esta forma, el límite de funcionamiento sin saturación es dado por la ecuación \eqref{eq:tension_armadura2}, valida en el instante $t1$. El valor de la corriente de armadura se obtiene a partir del par del motor $M1$ comocalculado a partir de la relación 
