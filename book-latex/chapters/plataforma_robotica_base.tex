...
Una vez ajustados ambos controladores es posible realizar un ajuste fino de los mismos. Siguiendo el mismo procedimiento descrito para el ajuste, se incrementa el termino $K_p$ en un 20\% y se vuelve a ajustar el termino derivativo. Se repite esta operación sucesivamente hasta el momento en el que el termino $K_d$ no sea capaz de compensar el incremento de $K_p$.

Por último, se realiza un último ajuste de los controladores a partir de las consignas dadas por el perfil de velocidad trapezoidal con el fin de obtener una fase de aceleración y frenado óptimo.
