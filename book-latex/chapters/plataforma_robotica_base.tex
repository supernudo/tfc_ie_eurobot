...
El valor de $Ka$ depende del peso del robot, del neumático utilizado y la calidad del campo de juego. El coeficiente de adherencia de las ruedas será independiente de la masa del robot siempre que la presión del neumático contra el suelo sea la misma. 


En las mejores condiciones se pueden alcanzar valores de $Ka$ entorno a 1.
...
Una vez ejecutado el método el coeficiente de adherencia viene dado por las medidas realizadas según la expresión
