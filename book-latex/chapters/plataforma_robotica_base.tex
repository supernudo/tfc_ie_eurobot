...
\subsection{Sistema de tracción diferencial}
...
\subsection{Sistema de posicionamiento y control de posición}
...
\section{Estudio y diseño de robots de tracción diferencial}

\subsection{Dinámica básica}
...
El control de posición implementado es de tipo polar, es decir la posición del robot viene dada por su distancia $d$ y ángulo $a$ absoluto respecto a un origen de coordenadas. 
