...
Por otro lado, del modelo en régimen permanente de un motor de corriente continua, se sabe que la tensión de armadura del motor $U$ y el par motor $M$ vienen dados por las expresiones:
\begin{align}
...
\begin{align}
U &= U_{max} = V_{bat} \label{eq:V_{bat}} \\
i|_{\omega = 0} &= \frac{V_{bat}}{r} \label{eq:i_w_zero} \\
M2 &= K_m\,i = K_m\,\frac{V_{bat}}{r} \label{eq:M2}
\end{align}
...
\begin{equation}
\boxed{K_{min} = 1,2\,\frac{K_a\,mg\,(d2/d)\,D\,r}{4\,K_m\,Rd\,V_{bat}}} \label{eq:kmin}
\end{equation}
