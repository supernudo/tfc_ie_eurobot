...
El procedimiento para la medida del error $E_b$ consiste en hacer girar al robot sobre su centro de giro. Dado que el cálculo del ángulo del robot \eqref{theta_n} $\theta$ es inversamente proporcional a la distancia entre ejes $b$ el método utilizado busca amplificar el error producido por $b$ girando un numero $n$ de vueltas enteras.
