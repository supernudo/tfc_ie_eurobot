...
El sistema de evitación de obstáculos está compuesto por varios sensores de corto alcance situados en las caras del robot (ver figura \ref{fig:plataforma_parte_sensores} y un sistema de detección del oponente de largo alcance basado en un sensor tipo faro y balizas reflectantes (ver figura \ref{fig:plataforma_parte_baliza}.

\begin{figure}[h]
\centering
%\includegraphics[height=.3\textheight]{sistema_traccion}
\caption[]{Partes del sistema de evitación de obstaculos. Robot XXX}
\label{fig:plataforma_partes_control_posicion}
\end{figure}


La implementación de todos los sistemas y funcionalidades la plataforma robótica ha sido realizada a partir de las librerías Aversive4dspic. Estas librerías son una migración de las librerías Aversive \cite{aversive} (microcontroladores AVR) a microcontroladores dsPIC y PIC24.
...
El sistema de tracción diferencial es uno de los más comunes en Eurobot. Como muestra la figura \ref{fig:sistema_traccion}, está compuesto por dos ruedas motrices unidas a motores mediante una reductora y varios puntos de apoyo.
...
Los puntos de apoyo utilizados normalmente son de tipo \emph{rollon}, en caso de no disponer de espacio suficiente también es posible utilizar materiales de bajo coeficiente de rozamiento como el teflón (ver figura \ref{fig:sistema_traccion_rollones}).
