...
\texttt{xcolor}. La solución fue incluir las opciones \texttt{[RGB,rgb]}
de dicho paquete en el \texttt{documentclass}, y eliminar la inclusión
de \texttt{xcolor} (que ya lo incluye, al menos, \texttt{listings}). No
es muy bonito como solución, pero funciona.
...
\begin{figure}[tphb]
  \centering
%FIXME  \includegraphics{Esquema_objetos.pdf}
...
Y finalmente la que nos falta: \ac{xidet}, también dentro de fórmulas
