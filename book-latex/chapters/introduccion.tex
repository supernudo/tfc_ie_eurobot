...
La siguiente tabla muestra un resumen de los robots desarrollados para la competición Eurobot (en los que ha participado el autor del libro) desde el 2003 hasta el 2015 y las personas implicadas en su desarrollo.

\begin{center}
	\begin{longtable}{|c|c|c|p{5cm}|}
    \caption{Robots desarrollados para la competición Eurobot (2003-2015).} \label{tab:robots_desarrollados} \\
    
    \hline 
	\multicolumn{1}{|c|}{\textbf{Año}} & 
...
%	Daniel Pizarro Perez \\
	...
	% integrantes
	Diego Alonso García \newline
	Enrique Moraleja García \newline
	Jose Manuel Gómez Sanchez	\newline
	Alberto Sanchez Rodríguez \newline
	Gustavo Tapias \newline
	\textbf{TODO:} (persona estrategia 1) \newline
	\textbf{TODO:} (persona estrategia 2) \newline
	Santiago Cobreces Alvarez \newline
	Daniel Pizarro Perez \newline
	\textbf{TODO:} (persona mecánica) \newline
	Mario Inglés Garcés \newline
	...
	Enrique Moraleja García \newline
	Jose Manuel Gómez Sanchez	\newline
	Raúl Sanchez de la Montaña \newline
	\textbf{TODO:} Javier ... \newline
	\textbf{TODO:} Amigo de Raúl y Javier ... \newline
	Saleta Nistal \newline
	Noelia Requena \newline
	Mario Inglés Garcés \newline
	Javier Baliñas Santos \\
...
%	Marcelo Salazar Acucci 
    ...
    \hline	
	% año, prueba, robot
	2012 & Treasure island & Crispín y Automático &
	% integrantes
	Sergio Arroyo Sierra \newline
	Nilo Masias Carranza \newline
	Mario Inglés Garcés \newline
    ...
    \hline	
	% año, prueba, robot
	2014 & Prehistobot & Grosnik y Seskäpa &
	% integrantes
	Mario Inglés Garcés \newline
	Diego Salazar Acucci \newline		 
	Silvia Santano Guillén \newline
...
\item \textbf{Sistemas mecánicos para la manipulación de elementos de juego:}
...
\item \textbf{Implementación de la estrategia de juego:}
