...
Este trabajo de fin de carrera constituye en sí un ejemplo de la robótica como herramienta educativa. Los robots desarrollados ha ayudado adquirir experiencia, conocimientos y experiencias de gran valor añadido a los estudios realizados.

A sí por ejemplo, en el campo de la ingeniería del software en sistemas embebidos\cite{making_embedded_systems} se han adquirido conocimientos de: manejo y adaptación de librerías software de terceros, gestión de control de versiones, implementación modular y estratificada, detección e implementación de patrones, compilación condicional, profundización en el proceso de compilación cruzada y optimización de código fuente e implementación de simuladores o entornos de prueba\footnote{También conocidos en la literatura anglosajona como \emph{sandbox}.}.
