...
La comunidad de Eurobot se comunica a través de su foro oficial\cite{foro_eurobot} y del foro de la Copa de Francia de la robótica \cite{foro_copa_francia}. En los foros es donde Además, cada equipo suele tener una página web, blog o canal de Youtube donde comparte los avances de los robots y ...

Eurobot está organizada gracias la asociación de Eurobot y a la asociación \emph{Planet Sciences}\cite{planet_sciences} y a muchas otras asociaciones, escuelas, universidades y personas voluntarias. Es increíble la cantidad de personas que apoyan Eurobot y trabajan de forma voluntaria sin ninguna remuneración más que la satisfacción de estar implicados y formar parte de esta fiesta que es Eurobot. Y esto incluye a los participantes, ya que ganar Eurobot no implica ningún premio económico. En total, un montón de gente que trabaja para disfrutar y divertirse con la robótica.
