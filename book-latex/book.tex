...
\chapter{Control de posición}

\section{Arquitectura mecánica y hardware}

\section{Cinematica y coeficiente de aderencia}
\section{Deslizamiento en fase de aceleración}
\section{Elección del perfil de velocidad}
\section{Leyes mecánicas y termicas de un motor DC}

\section{Control PID}
\section{Control polar} 

\section{Ajuste del controlador PID}
\section{El bloqueo del motor}
\section{Elección de la velocidad y aceleración adecuadas}

\section{Detección de bloqueos}


\chapter{Generación de trayectorias}

\chapter{Posicionamiento mediante odometría}
\section{Fundamento teórico}
\section{Medida y corrección de errores sistematicos}
\section{Compensación de la fuerza centripeta}

\chapter{Posicionamiento mediante balizas}
...
\chapter{Comunicación entre dos robots}
