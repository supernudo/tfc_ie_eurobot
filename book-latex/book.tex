...
\input{chapters/el_robot_de_eurobot.tex}
\input{chapters/plataforma_robotica_base.tex}
...
\chapter{Sistema de balizas para la medida de la posición del oponente}
...
\chapter{Implementación software}
	...
	% [actuators | sensors | cs] > [strat (base, utils, avoid)] | [Interfaz baliza] | [Interfaz secondary_robot]  
	\section{Estrategia de juego}
	% [tareas secondary_robot] | [tareas main_robot] > [trayectorias a zonas | trabajo en zonas] > [estrategias partido]
...
%\section{Expectativas, motivación y objetivos}
%\section{Tareas principales}
%\section{Organización y metodología del trabajo}


%\chapter{Sistemas mecánicos para la manipulación de elementos de juego}
%\section{Introducción}
%\section{Soluciones mecánicas conocidas}
%	\subsection{Análisis de mecanismos utilizados según los elementos de juego}
%	\subsection{Conclusiones en la elección de un sistema mecánico}

%\section{Partes de un sistema mecánico}

%\section{Lectura y procesamiento de sensores}
%	\subsection{Tipos de sensores}
%	\subsection{Electrónica de acondicionamiento}
...
% XXX DEPRECATED XXX %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\chapter{Implementación de la estrategia de juego}
%\section{Introducción}
%	\begin{itemize}
%	\item Union de la plataforma robótica y los sistemas mecánicos.
%\end{itemize}
%\section{Abstracción de la plataforma robótica base}
%	\subsection{Integración de la detección de obstáculos en trayectorias}
...
%	\item Tipos de trayectorias en función del campo de juego (caminos libres vs preestablecidos)
%	\item{Independencia de los sistemas mecánicos y las trayectorias}
...
%	\subsection{Condiciones en la elección de una zona de trabajo}
%\section{Arquitectura software}
...
%\section{Simulación de estrategias}
%\section{Patrones de implementación de estrategia}
%	\subsection{Estrategia secuencial bloqueante}
%	\subsection{Estrategia reactiva}
%	\subsection{Estratégia basada en prioridades}
%	\subsection{Estratégia adaptativa}
%	\subsection{Estrategia con dos robots}
%\section{Pruebas, depuración y validación de la estrategia}
