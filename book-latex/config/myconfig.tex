...
\newcommand{\mybooktitle}{Desarrollo de robots para Eurobot}
...
\newcommand{\mybookpalabrasclave}{Robots de Eurobot, manual de referencia, gestión, electrónica, mecánica, software} % (máximo de cinco)
